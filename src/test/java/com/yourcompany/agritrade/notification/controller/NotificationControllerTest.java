...
import com.yourcompany.agritrade.notification.controller.NotificationController;
...
class NotificationControllerTest {
    ...
    class GetNotificationsTests {
        ...
        @Test
        @DisplayName("GET /api/notifications/my/unread-count - Lấy Số lượng Thông báo Chưa đọc - Thành công")
        void getMyUnreadCount_success() throws Exception {
            when(notificationService.getMyUnreadNotificationCount(any(Authentication.class))).thenReturn(5L);
    ...
    class MarkNotificationTests {
        ...
        void markAsRead_success() throws Exception {
            ...
            doNothing().when(notificationService).markNotificationAsRead(any(Authentication.class), eq(notificationId));
        ...
        void markAsRead_notFound() throws Exception {
            ...
            doThrow(new ResourceNotFoundException("Notification", "id", notificationId))
                    .when(notificationService).markNotificationAsRead(any(Authentication.class), eq(notificationId));
        ...
        void markAllAsRead_success() throws Exception {
            ...
            mockMvc.perform(post("/api/notifications/my/read-all"))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.success", is(true)))
    ...
    class DeleteNotificationTests {
        ...
        void deleteNotification_success() throws Exception {
            Long notificationId = 1L;
            doNothing().when(notificationService).deleteNotification(any(Authentication.class), eq(notificationId));
        ...
        void deleteNotification_notFound() throws Exception {
            Long notificationId = 99L;
            doThrow(new ResourceNotFoundException("Notification", "id", notificationId))
                    .when(notificationService).deleteNotification(any(Authentication.class), eq(notificationId));
