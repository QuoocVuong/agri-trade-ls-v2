...
class FarmerProfileControllerUnitTest {
  ...
  @InjectMocks private FarmerProfileController farmerProfileController;
  ...
  void createOrUpdateMyProfile_success_returnsOkWithProfile() {
    when(farmerProfileService.createOrUpdateFarmerProfile(authentication, profileRequest))
