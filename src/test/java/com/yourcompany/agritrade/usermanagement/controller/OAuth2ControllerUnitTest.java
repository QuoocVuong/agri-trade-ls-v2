...
class OAuth2ControllerUnitTest {
  ...
  @Test
  void verifyGoogleToken_serviceThrowsBadRequest_returnsBadRequest()
    ...
    ResponseEntity<ApiResponse<LoginResponse>> responseEntity =
        oauth2Controller.verifyGoogleToken(googleLoginRequest);
  ...
  @Test
  void verifyGoogleToken_serviceThrowsGeneralSecurityException_returnsBadRequest()
      throws GeneralSecurityException, IOException {
    when(userService.processGoogleLogin("test-google-id-token"))
