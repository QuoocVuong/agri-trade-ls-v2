...
class AuthControllerUnitTest {
  ...
  void setUp() {
    ...
    loginResponseData =
        new LoginResponse("sampleAccessToken", "sampleRefreshToken", userInLoginResponse);
  ...
  void registerUser_success_returnsCreated() {
    ...
    ResponseEntity<ApiResponse<UserResponse>> responseEntity =
  ...
  void refreshToken_success_returnsOkWithNewTokens() {
    ...
    ResponseEntity<ApiResponse<LoginResponse>> responseEntity =
        authController.refreshToken(refreshTokenStringWithQuotes);
    assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
    assertTrue(responseEntity.getBody().isSuccess());
  ...
  void logoutUser_success_returnsOkAndInvalidatesToken() {
    ...
    ResponseEntity<ApiResponse<Void>> responseEntity =
        authController.logoutUser(httpServletRequest);
