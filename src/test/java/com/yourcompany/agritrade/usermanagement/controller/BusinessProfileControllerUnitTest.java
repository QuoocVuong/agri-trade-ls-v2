...
class BusinessProfileControllerUnitTest {
  ...
  @InjectMocks private BusinessProfileController businessProfileController;
  ...
  void createOrUpdateMyProfile_success_returnsOkWithProfile() {
    when(businessProfileService.createOrUpdateBusinessProfile(authentication, profileRequest))
