...
class AdminDashboardControllerUnitTest {
  ...
  void setUp() {
    ...
    revenueChartData =
        Collections.singletonList(new TimeSeriesDataPoint<>(LocalDate.now(), BigDecimal.TEN));
    // ...
  }
  ...
  void getRevenueChartData_success_returnsOkWithChartData() {
    ...
    when(dashboardService.getDailyRevenueForAdminChart(startDate, endDate))
        .thenReturn(revenueChartData);
