...
@TestConfiguration
@EnableMethodSecurity(prePostEnabled = true, securedEnabled = true, jsr250Enabled = true) // BẬT METHOD SECURITY CHO TEST
public class TestSecurityConfig {
    ...
    public JwtProperties jwtProperties() {
        ...
        lenient().when(jwtProps.getSecret()).thenReturn("c29tZXRoaW5nZWxzZWdldGhpbmdzZWxzZWdldGhpbmdzZWxzZWdldGhpbmdzZWxzZWdldGhpbmdzZWxzZQ==");
    ...
    @Bean
    @Primary
    public JwtAuthenticationFilter jwtAuthenticationFilter(JwtTokenProvider jwtTokenProvider, TokenBlacklistService tokenBlacklistService) {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter, JwtAuthenticationEntryPoint unauthorizedHandler) throws Exception {
        http
