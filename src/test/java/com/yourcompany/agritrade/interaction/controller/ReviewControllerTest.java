...
import com.yourcompany.agritrade.interaction.controller.ReviewController;
...
class ReviewControllerTest {
    ...
    class CreateReviewTests {
        ...
        void createReview_userHasNotPurchased_throwsBadRequest() throws Exception {
            ...
            mockMvc.perform(post("/api/reviews")
                    ...
                    .andExpect(status().isBadRequest())
                    .andExpect(jsonPath("$.success", is(false)))
                    .andExpect(jsonPath("$.message", is("You must purchase this product to leave a review.")));
        }
    }
    ...
    class GetReviewsTests {
        @Test
        @DisplayName("GET /api/reviews/product/{productId} - Lấy Đánh giá Đã duyệt của Sản phẩm - Thành công")
