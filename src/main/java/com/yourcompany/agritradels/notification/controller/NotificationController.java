package com.yourcompany.agritradels.notification.controller;
...
public class NotificationController {
    ...
    public ResponseEntity<ApiResponse<Page<NotificationResponse>>> getMyNotifications(
        ...
        Page<NotificationResponse> notifications = notificationService.getMyNotifications(authentication, pageable);
    ...
    public ResponseEntity<ApiResponse<Void>> markAsRead(Authentication authentication, @PathVariable Long notificationId) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteNotification(Authentication authentication, @PathVariable Long notificationId) {
