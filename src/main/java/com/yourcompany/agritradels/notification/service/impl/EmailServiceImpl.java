...
import com.yourcompany.agritradels.ordering.domain.PaymentTransactionStatus;
import com.yourcompany.agritradels.usermanagement.domain.FarmerProfile; // Import FarmerProfile
...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendWelcomeEmail(User user) {
        ...
        context.setVariable("username", user.getFullName());
        context.setVariable("appName", appName);
        context.setVariable("loginUrl", frontendUrl + "/login"); // Ví dụ link đăng nhập
