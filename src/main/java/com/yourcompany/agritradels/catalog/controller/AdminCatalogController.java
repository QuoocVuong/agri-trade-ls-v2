...
import com.yourcompany.agritradels.catalog.dto.request.ProductRejectRequest; // Import DTO reject
...
public class AdminCatalogController {
    ...
    public ResponseEntity<ApiResponse<ProductDetailResponse>> getProductByIdForAdmin(@PathVariable Long id) {
        // Gọi phương thức đã implement trong ProductService
