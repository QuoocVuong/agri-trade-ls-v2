...
import com.yourcompany.agritradels.catalog.domain.*;
import com.yourcompany.agritradels.catalog.dto.request.ProductImageRequest;
...
import com.yourcompany.agritradels.catalog.mapper.ProductImageMapper;
import com.yourcompany.agritradels.catalog.mapper.ProductMapper;
import com.yourcompany.agritradels.catalog.mapper.ProductPricingTierMapper; // Import mapper bậc giá
import com.yourcompany.agritradels.catalog.repository.*;
import com.yourcompany.agritradels.catalog.repository.specification.ProductSpecifications; // Import Specifications
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDetailResponse createMyProduct(Authentication authentication, ProductRequest request) {
        ...
        product.setStatus(ProductStatus.DRAFT); // Luôn bắt đầu là DRAFT
