package com.yourcompany.agritradels.usermanagement.dto.response; // Đặt trong usermanagement hoặc common

import lombok.Builder; // Sử dụng Builder pattern cho dễ khởi tạo
import lombok.Data;
