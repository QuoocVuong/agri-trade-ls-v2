...
import com.yourcompany.agritradels.interaction.mapper.FollowUserMapper;
import com.yourcompany.agritradels.interaction.repository.UserFollowRepository;
import com.yourcompany.agritradels.interaction.service.FollowService;
...
import com.yourcompany.agritradels.usermanagement.service.impl.UserServiceImpl; // Import để dùng helper
...
public class FollowServiceImpl implements FollowService {
    ...
    public Page<FollowUserResponse> getFollowing(Authentication authentication, Pageable pageable) {
        ...
        List<FollowUserResponse> responseList = followUserMapper.toFollowUserResponseList(followingUsers);
    ...
    public Page<FollowUserResponse> getFollowers(Authentication authentication, Pageable pageable) {
        ...
        List<FollowUserResponse> responseList = followUserMapper.toFollowUserResponseList(followerUsers);
    ...
    private void updateFollowCounts(Long followerId, Long followingId, boolean isFollowing) {
        ...
        if (follower != null && following != null) {
            ...
            follower.setFollowingCount(currentFollowingCount); // Truyền int vào setter nhận Integer (auto-boxing)
            following.setFollowerCount(currentFollowerCount); // Truyền int vào setter nhận Integer

            userRepository.save(follower);
            userRepository.save(following);
            log.debug("Updated follow counts for follower {} ({}) and following {} ({})",
                    followerId, currentFollowingCount, followingId, currentFollowerCount);
        }
    }
}