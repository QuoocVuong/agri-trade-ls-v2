...
import com.yourcompany.agritradels.usermanagement.dto.response.UserInfoSimpleResponse; // Import DTO user đơn giản
import lombok.Data;
...
public class ChatRoomResponse {
    ...
    private int myUnreadCount; // Số tin nhắn chưa đọc của user đang xem list này (cần tính trong service)
    private UserInfoSimpleResponse otherUser; // Thông tin của người còn lại trong phòng chat (cần tính trong service)
