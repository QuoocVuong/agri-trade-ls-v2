...
import com.yourcompany.agritradels.interaction.domain.MessageType;
import com.yourcompany.agritradels.usermanagement.dto.response.UserInfoSimpleResponse; // DTO user đơn giản
import lombok.Data;
