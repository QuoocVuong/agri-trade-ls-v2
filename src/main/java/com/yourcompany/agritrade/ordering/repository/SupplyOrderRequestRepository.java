...
public interface SupplyOrderRequestRepository extends JpaRepository<SupplyOrderRequest, Long>, JpaSpecificationExecutor<SupplyOrderRequest> {
    ...
    List<SupplyOrderRequest> findByFarmerIdAndBuyerIdAndProductIdAndStatus(
            ...
            Long buyerId,
            Long productId,
            SupplyOrderRequestStatus status
    );
