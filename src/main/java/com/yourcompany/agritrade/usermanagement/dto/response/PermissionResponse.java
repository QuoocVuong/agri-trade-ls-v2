...
public class PermissionResponse {
  ...
  /**
   * Tên định danh duy nhất của quyền hạn (ví dụ: "USER_READ_ALL", "PRODUCT_CREATE"). Thường dùng để
   * kiểm tra quyền trong code hoặc hiển thị cho admin.
   */
  private String name;

  /**
   * Mô tả chi tiết về mục đích hoặc ý nghĩa của quyền hạn này (có thể null). Hữu ích để hiển thị
   * cho admin hiểu rõ hơn về quyền.
   */
