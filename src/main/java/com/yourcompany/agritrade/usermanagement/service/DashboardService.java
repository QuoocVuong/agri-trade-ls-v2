...
import com.yourcompany.agritrade.catalog.dto.response.TopProductResponse; // Import
import com.yourcompany.agritrade.ordering.dto.response.OrderSummaryResponse; // Import
...
public interface DashboardService {
    ...
    List<FarmerChartDataResponse> getFarmerOrderCountChartData(Authentication authentication, LocalDate startDate, LocalDate endDate); // <<<< THÊM PHƯƠNG THỨC NÀY

    /** Lấy dữ liệu doanh thu theo ngày cho biểu đồ Farmer */
    List<FarmerChartDataResponse> getFarmerRevenueChartData(Authentication authentication, LocalDate startDate, LocalDate endDate); // <<<< THÊM PHƯƠNG THỨC NÀY
    // ==========================================
