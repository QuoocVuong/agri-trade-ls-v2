...
public interface AdminUserService {
   ...
   * @return Thông tin profile đầy đủ. //* @throws ResourceNotFoundException Nếu không tìm thấy
   *     user.
   */
   ...
   * @return Thông tin user đã cập nhật. //* @throws ResourceNotFoundException Nếu không tìm thấy
   *     user.
   */
   ...
   * @return Trang danh sách Farmer Profile đầy đủ (UserProfileResponse).
   */
  Page<UserProfileResponse> getAllFarmers(
   ...
   * @param adminAuth Thông tin admin thực hiện. // * @throws ResourceNotFoundException Nếu không
   *     tìm thấy Farmer Profile. // * @throws BadRequestException Nếu profile không ở trạng thái
   *     PENDING.
   */
