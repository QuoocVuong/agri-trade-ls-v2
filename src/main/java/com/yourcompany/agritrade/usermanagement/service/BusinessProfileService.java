...
public interface BusinessProfileService {
  ...
  /**
   * Tạo hoặc cập nhật thông tin profile cho người mua là doanh nghiệp đang đăng nhập. Chỉ user có
   * vai trò ROLE_BUSINESS_BUYER mới thực hiện được. Đảm bảo tỉnh đăng ký kinh doanh là Lạng Sơn.
   *
   ...
   */
  BusinessProfileResponse createOrUpdateBusinessProfile(
      Authentication authentication, BusinessProfileRequest request);

  /**
   * Lấy thông tin profile của một doanh nghiệp dựa trên userId. Có thể dùng để hiển thị công khai
   * hoặc cho các mục đích nội bộ.
   *
