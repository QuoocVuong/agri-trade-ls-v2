package com.yourcompany.agritrade.usermanagement.controller; // Đặt trong usermanagement hoặc module dashboard riêng
...
public class FarmerDashboardController {
    ...
    public ResponseEntity<ApiResponse<List<FarmerChartDataResponse>>> getOrderCountChartData(
        ...
        List<FarmerChartDataResponse> chartData = dashboardService.getFarmerOrderCountChartData(authentication, startDate, endDate);
    ...
    public ResponseEntity<ApiResponse<List<FarmerChartDataResponse>>> getRevenueChartData(
        ...
        // Gọi phương thức trong service để lấy dữ liệu (cần implement trong DashboardService)
        List<FarmerChartDataResponse> chartData = dashboardService.getFarmerRevenueChartData(authentication, startDate, endDate);
