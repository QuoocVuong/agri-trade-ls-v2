...
import com.yourcompany.agritrade.usermanagement.dto.request.AddressRequest; // Tạo DTO này nếu chưa có
import com.yourcompany.agritrade.usermanagement.dto.response.AddressResponse; // Import DTO response
