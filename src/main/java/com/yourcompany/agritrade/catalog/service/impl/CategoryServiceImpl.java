...
import com.yourcompany.agritrade.catalog.repository.ProductRepository; // Inject ProductRepository
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<CategoryResponse> getAllCategoriesForDropdown() {
        ...
        // List<Category> categories = categoryRepository.findByIsActiveTrueOrderByNameAsc(); // Nếu có trường isActive
        List<Category> categories = categoryRepository.findAll(Sort.by(Sort.Direction.ASC, "name")); // Lấy tất cả, sắp xếp theo tên
