...
public class ChatRoom {
  ...
  public boolean equals(Object o) {
    ...
    return (Objects.equals(user1.getId(), chatRoom.user1.getId())
            && Objects.equals(user2.getId(), chatRoom.user2.getId()))
        || (Objects.equals(user1.getId(), chatRoom.user2.getId())
            && Objects.equals(user2.getId(), chatRoom.user1.getId()));
  }
